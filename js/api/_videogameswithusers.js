...
const videogameswithusersAPI_auto = {

    /** Gets all entries from 'videogameswithusers' */
    getAll: async function() {
        let response = await axios.get(`${BASE_URL}/videogameswithusers`, requestOptions);
        return response.data;
    },
};

export { videogameswithusersAPI_auto };